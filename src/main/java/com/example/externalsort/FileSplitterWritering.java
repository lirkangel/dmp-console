...
public class FileSplitterWritering  extends FileWritering implements Callable<Boolean> {
    private FileSplitter fileSplitter;
    private String tempFilesDir = ConfigProperties.TEMP_FILES_DIR.value();


    public FileSplitterWritering(FileSplitter fileSplitter) {
    ...
    protected File getFile(String prefix, String line) {
        ...
        if (file == null) {
            ...
            Long maxTempFileSize = Long.valueOf(ConfigProperties.MAX_TEMP_FILE_SIZE.value());
